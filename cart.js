...
function renderCartItem(product)
{
  ...
  removeFromCart.className = "m-1 p-1 border border-black bg-red-100 hover:bg-red-200 text-sm";
...
proceedBtn.className = "m-2 p-2 border border-black bg-green-500 text-white hover:bg-green-600";
