...
prevBtn.className = "m-1 p-2 border border-gray-300 bg-white hover:bg-gray-100";
prevBtn.innerText = "<";
...
pageCountBox.className = "m-1 p-2 border border-gray-300";


let nextBtn = document.createElement("button");
nextBtn.className = "m-1 p-2 border border-gray-300 bg-white hover:bg-gray-100";
nextBtn.innerText = ">";
...
function makeCategoryButtons(categoryArray)
{
    categoryArray.forEach(c => {
        ...
        cBtn.className = "m-1 p-1 border border-gray-300 bg-yellow-300 hover:bg-yellow-400 text-sm";
...
function makeProducts(productArray)
{
    productArray.forEach(product => {
       ...
       let wishListBtn = document.createElement("button");
        wishListBtn.className = "m-1 p-2 border border-gray-300";
        ...
        addToCart.className = "m-1 p-2 border border-gray-300";
