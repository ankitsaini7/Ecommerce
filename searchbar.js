...
searchBar.className = "m-2 p-2 border border-black";
...
searchInput.className = "border border-black p-1";
...
searchBtn.className = "border border-black p-2 bg-blue-200 hover:bg-blue-300";
...
allBtn.className = "m-1 p-1 border border-black bg-yellow-300 hover:bg-yellow-400";
